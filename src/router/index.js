...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      redirect: {path: '/index'},
      children: [
        {path: '/index', component: Index, name: '冷链管理', icon: 'icon-dangan'},
        {path: '/list', component: List, name: '冰箱管理'},
        {path: '/detail', component: Detail, name: '冰箱详情'},
        {path: '/result', component: Result, name: '修改'}
      ]
    }
  ]
})
